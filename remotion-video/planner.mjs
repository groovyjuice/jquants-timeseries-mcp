    ...
    scenes: {
      ...
      items: {
        ...
        properties: {
          ...
          emotion: {
            type: 'string',
            enum: ['normal', 'surprise', 'serious', 'smile'],
          },
...
export const planScenes = async (script) => {
  ...
  const response = await client.responses.create({
    ...
    instructions: [
      ...
      'Choose emotion from normal, surprise, serious, smile.',
      'Use smile for friendly openings, reassuring transitions, or positive closings.',
      'Use serious for risks, cautions, or important warnings.',
      'Use surprise for unusually large moves or high-impact developments.',
